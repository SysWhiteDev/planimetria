...
function Calendar({
    ...
    return (
        <DayPicker
            ...
            classNames={{
                months: "text-black dark:text-white flex flex-col sm:flex-row space-y-4 sm:space-x-4 sm:space-y-0",
                ...
                nav_button: "bg-transparent !p-2 transform-x-[8px] rounded-md opacity-60 hover:opacity-100 hover:bg-neutral-900 hover:dark:bg-neutral-600 hover:bg-opacity-10",
                nav_button_previous: "",
                nav_button_next: "",
                ...
                day_range_end: "dark:text-black text-black dark:bg-neutral-200 bg-neutral-300 rounded-none rounded-r-md",
                day_range_start: "day-range-start dark:text-black text-black dark:bg-neutral-200 bg-neutral-300 rounded-none rounded-l-md",
                day_range_middle:
                ...
                day_today: "border rounded-md border-neutral-600 dark:border-neutral-500",
                day_outside:
